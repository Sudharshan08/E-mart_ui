          ...
          : ourButton(
            onPress: () async {
              await controller.placeMyOrder(
                orderPaymentMethod: paymentMethods[controller.paymentIndex.value], totalAmount: controller.totalP.value
                );
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Image.asset(paymentMethodsImg[index], width: double.infinity, height: 150,fit: BoxFit.cover,),
